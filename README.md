...
- From the main menu, select File | Open.
 - In the dialog that opens, select the build.gradle file of the project you want to open. Click OK.
 - In the dialog that opens, click Open as Project.
 - IntelliJ IDEA opens and syncs the Gradle project in the IDE.
 - Once the project is open navigate to src/main/java/com/mindex/challenge/ChallengeApplication.java and run the main method.
